  ...
  return (
    <nav style={{
      ...
      <Link
        ...
        onMouseEnter={(e) => {
          if (location.pathname !== '/application-tracking-demo') {
            e.currentTarget.style.backgroundColor = 'rgba(255,255,255,0.2)';
          }
        }}
        onMouseLeave={(e) => {
      ...
      <Link
        ...
        onMouseEnter={(e) => {
          if (location.pathname !== '/zip-map-demo') {
            e.currentTarget.style.backgroundColor = 'rgba(255,255,255,0.2)';
          }
        }}
        onMouseLeave={(e) => {
      ...
      <Link
        ...
        onMouseEnter={(e) => {
          if (location.pathname !== '/zip-map-webgl-demo') {
            e.currentTarget.style.backgroundColor = 'rgba(255,255,255,0.2)';
          }
        }}
        onMouseLeave={(e) => {
